...
module.exports = {
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1512753785469602',
    clientSecret: process.env.FACEBOOK_SECRET || '0eb567784209aaeed98f538dcc4a2f9a',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '312179277208-ejovj9o3jnp574a8oltcpjib6ofpv7u4.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'VxyfKcwBmB0rPfQZoilhSmoo',
